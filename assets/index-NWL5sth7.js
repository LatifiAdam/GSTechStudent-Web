...
` +
    ...
    var jt = Math.random().toString(36).slice(2),
      Mt = `__reactFiber$` + jt,
      k = `__reactProps$` + jt,
      Nt = `__reactContainer$` + jt,
      Pt = `__reactEvents$` + jt,
      A = `__reactListeners$` + jt,
      j = `__reactHandles$` + jt,
      Ft = `__reactResources$` + jt,
      It = `__reactMarker$` + jt,
      Lt = `__reactLoad$` + jt;
    function Rt(e) {
      (delete e[Mt], delete e[k], delete e[A], delete e[j]);
    }
    function zt(e) {
      var t;
      if ((t = e[Mt])) return t;
    ...
    function vn(e, t, n) {
      ...
      if (((e = e.style), n != null)) {
        ...
        for (var a in t)
          ((r = t[a]),
            t.hasOwnProperty(a) && n[a] !== r && (_n(e, a, r), (N = !0)));
    ...
    function An(e, t, n) {
      ...
      try {
        ...
        if (
          ((kn = !1),
          (En !== null || Dn !== null) &&
            (zd(), En && ((t = En), (e = Dn), (Dn = En = null), On(t), e)))
        )
    ...
    var Un = {
      ...
      Xn = C({}, Gn, {
        ...
        movementX: function (e) {
          return `movementX` in e
            ...
            : (e !== Yn &&
                (Yn && e.type === `mousemove`
                  ? ((qn = e.screenX - Yn.screenX),
                    (Jn = e.screenY - Yn.screenY))
                  : (Jn = qn = 0),
                (Yn = e)),
              qn);
        },
      ...
      Zn = Hn(Xn),
      Qn = Hn(C({}, Xn, { dataTransfer: 0 })),
      $n = Hn(C({}, Gn, { relatedTarget: 0 })),
      er = Hn(
        C({}, Un, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
      ),
      tr = Hn(
        C({}, Un, {
    ...
    var cr = Hn(
      ...
      fr = Hn(C({}, Un, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
      pr = Hn(
        C({}, Xn, {
          deltaX: function (e) {
            return `deltaX` in e
      ...
      mr = Hn(C({}, Un, { newState: 0, oldState: 0, source: 0 })),
      hr = [9, 13, 27, 32],
      gr = Mn && `CompositionEvent` in window,
      _r = null;
    Mn && `documentMode` in document && (_r = document.documentMode);
    var vr = Mn && `TextEvent` in window && !_r,
      yr = Mn && (!gr || (_r && 8 < _r && 11 >= _r)),
      br = ` `,
      xr = !1;
    function Sr(e, t) {
      switch (e) {
    ...
    function Tr(e, t) {
      switch (e) {
        case `compositionend`:
          return Cr(t);
        case `keypress`:
          return t.which === 32 ? ((xr = !0), br) : null;
        case `textInput`:
          return ((e = t.data), e === br && xr ? null : e);
        default:
          return null;
      }
    }
    function Er(e, t) {
      if (wr)
        return e === `compositionend` || (!gr && Sr(e, t))
          ? ((e = Rn()), (Ln = In = Fn = null), (wr = !1), e)
          : null;
      switch (e) {
        case `paste`:
          return null;
    ...
    function Vr(e, t, n) {
      e === `focusin`
        ? (zr(), (Ar = t), (jr = n), Ar.attachEvent(`onpropertychange`, Br))
        : e === `focusout` && zr();
    }
    function Hr(e) {
    ...
    var ei = Mn && `documentMode` in document && 11 >= document.documentMode,
      ti = null,
      ni = null,
      ri = null,
      ii = !1;
    ...
    function qi(e, t) {
      if (typeof e == `object` && e) {
        var n = Ki.get(e);
        return n === void 0
          ? ((t = { value: e, source: t, stack: Ge(t) }), Ki.set(e, t), t)
          : n;
      }
    ...
    function pa(e) {
      ...
      switch (((t[Mt] = e), (t[k] = r), n)) {
        ...
        case `select`:
          ...
          break;
        case `textarea`:
          (Q(`invalid`, t), mn(t, r.value, r.defaultValue, r.children));
      }
      ((n = r.children),
        (typeof n != `string` &&
          typeof n != `number` &&
    ...
    function ha(e) {
      ...
      if (
        ...
        t === 27
          ? ((t = F), Sp(e.type) ? ((e = um), (um = null), (F = e)) : (F = t))
          : (F = ca ? lm(e.stateNode.nextSibling) : null);
      return !0;
    }
    function ga() {
      ((F = ca = null), (I = !1));
    ...
    function _a() {
      ...
      return (
        e !== null &&
          (pd === null ? (pd = e) : pd.push.apply(pd, e), (la = null)),
        e
      );
    }
    function va(e) {
    ...
    var ya = ke(null),
      ...
      xa = null;
    function Sa(e, t, n) {
      (D(ya, t._currentValue), (t._currentValue = n));
    }
    function Ca(e) {
      ((e._currentValue = ya.current), Ae(ya));
    }
    function wa(e, t, n) {
      for (; e !== null; ) {
        var r = e.alternate;
    ...
    function ja(e, t) {
      ...
      if (((t = { context: t, memoizedValue: n, next: null }), xa === null)) {
    ...
    T.S = function (e, t) {
      if (
        ...
        for (var n = bf; n !== null; ) (Ra(n, za), (n = n.next));
      if (((n = e.types), n !== null)) {
    ...
    function ho(e) {
      ...
      function l(e, t, n, r) {
        var i = n.type;
        return i === w
          ? ((e = d(e, t, n.props.children, r, n.key)), po(e, n), e)
          : t !== null &&
              (t.elementType === i ||
                (typeof i == `object` &&
                  i &&
                  i.$$typeof === he &&
                  ao(i) === t.type))
            ? ((t = a(t, n.props)), po(t, n), (t.return = e), t)
      ...
      function _(e, r, o, c) {
        if (
          ...
          if (o.$$typeof === ue) return _(e, r, Aa(e, o), c);
          mo(e, o);
        }
    ...
    var Ao = ke(null),
      jo = ke(0);
    function Mo(e, t) {
      ((e = od), D(jo, e), D(Ao, t), (od = e | t.baseLanes));
    }
    function No() {
      (D(jo, od), D(Ao, Ao.current));
    }
    function Po() {
      ((od = jo.current), Ae(Ao), Ae(jo));
    }
    var Fo = ke(null),
      Io = null;
    function Lo(e) {
    ...
    function Ro(e) {
      (D(Ho, Ho.current), D(Fo, e), Io === null && (Io = e));
    }
    function zo(e) {
      e.tag === 22
        ? (D(Ho, Ho.current), D(Fo, e), Io === null && (Io = e))
    ...
    function Bo() {
      (D(Ho, Ho.current), D(Fo, Fo.current));
    }
    function Vo(e) {
      (Ae(Fo), Io === e && (Io = null), Ae(Ho));
    }
    var Ho = ke(0);
    function Uo(e, t) {
      (D(Fo, Fo.current), D(Ho, t));
    }
    function Wo(e) {
      (Ae(Ho), Ae(Fo), Io === e && (Io = null));
    }
    function Go(e) {
      for (var t = e; t !== null; ) {
        if (t.tag === 13) {
    ...
    function ns(e, t, n, r, i, a) {
      return (
        ...
        (t.updateQueue = null),
        (t.lanes = 0),
        (T.H = e === null || e.memoizedState === null ? vc : yc),
        (Xo = !1),
        (a = n(r, i)),
        (Xo = !1),
        Yo && (a = is(t, n, r, i)),
    ...
    function rs(e) {
      ...
      e === null ||
        Ic ||
        ((e = e.dependencies), e !== null && Da(e) && (Ic = !0));
    }
    function is(e, t, n, r) {
      L = e;
      var a = 0;
    ...
    function ds(e) {
      ...
      return (
        ...
        (qo === null ? t.memoizedState : qo.next) === null &&
          ((t = t.alternate),
          (T.H = t === null || t.memoizedState === null ? vc : yc)),
        e
      );
    }
    function fs(e) {
    ...
    function gs(e, t, n) {
      ...
      if (((o = e.baseState), a === null)) e.memoizedState = o;
        ...
        if (
          (l === null ? (s = o) : (l.next = c),
          !Kr(o, e.memoizedState) && ((Ic = !0), d && ((n = Wa), n !== null)))
        )
          throw n;
        ((e.memoizedState = o),
          (e.baseState = s),
    ...
    function vs(e, t, n) {
      ...
      if (
        ...
        Rs(e ? 9 : 8, { destroy: void 0 }, bs.bind(null, r, a, n, t), null),
        e)
      ) {
    ...
    function ys(e, t, n) {
      ((e.flags |= 16384),
        ...
        (t = L.updateQueue),
        t === null
          ? ((t = us()), (L.updateQueue = t), (t.stores = [e]))
    ...
    function As(e, t, n) {
      ...
      if (((e.pending = null), r !== null)) {
        r = r.next;
        do ((t.status = `rejected`), (t.reason = n), js(t), (t = t.next));
        while (t !== r);
      }
      e.action = null;
    }
    ...
    function Fs(e, t, n) {
      ...
      return (
        n !== t.memoizedState &&
          ((L.flags |= 2048),
          Rs(9, { destroy: void 0 }, Is.bind(null, i, n), null)),
        [r, a, e]
      );
    }
    function Is(e, t) {
    ...
    function Vs(e, t, n, r) {
      ...
      R !== null && r !== null && ts(r, R.memoizedState.deps)
        ? (i.memoizedState = Rs(t, a, n, r))
        : ((L.flags |= e), (i.memoizedState = Rs(1 | t, a, n, r)));
    }
    function Hs(e, t) {
      Bs(8390656, 8, e, t);
    }
    ...
    function $s(e, t, n) {
      return n === void 0 || (Ko & 1073741824 && !(q & 261930))
        ? (e.memoizedState = t)
        : ((e.memoizedState = n), (e = Md()), (L.lanes |= e), (sd |= e), n);
    }
    function ec(e, t, n, r) {
      return Kr(n, t)
        ? n
        : Ao.current === null
          ? !(Ko & 106) || (Ko & 1073741824 && !(q & 261930))
            ? ((Ic = !0), (e.memoizedState = n))
            : ((e = Md()), (L.lanes |= e), (sd |= e), t)
          : ((e = $s(e, n, r)), Kr(e, t) || (Ic = !0), e);
    }
    function tc(e, t, n, r, i) {
      ...
      var o = T.T,
        s = {};
      ((s.types = o === null ? null : o.types), (T.T = s), pc(e, !1, t, n));
      try {
        var c = i(),
          l = T.S;
        (l !== null && l(s, c),
        ...
        fc(e, t, { then: function () {}, status: `rejected`, reason: n }, jd());
      } finally {
        ((E.p = a),
    ...
    function uc(e, t, n) {
      ...
      ((n = {
        ...
        mc(e)
          ? hc(t, n)
          : ((n = ji(e, t, n, r)), n !== null && (Pd(n, e, r), gc(n, t, r))));
    }
    function dc(e, t, n) {
      fc(e, t, n, jd());
    }
        ...
        if (
          ...
          try {
            ...
            if (((i.hasEagerState = !0), (i.eagerState = s), Kr(s, o)))
              return (Ai(e, t, i, 0), G === null && ki(), !1);
          } catch {}
        if (((n = ji(e, t, i, r)), n !== null))
          return (Pd(n, e, r), gc(n, t, r), !0);
      }
      return !1;
    }
    function pc(e, t, n, r) {
      ...
      vc = {
        ...
        useSyncExternalStore: function (e, t, n) {
          ...
          return (
            ...
            (r.flags |= 2048),
            Rs(9, { destroy: void 0 }, bs.bind(null, r, o, n, t), null),
            n
          );
        },
        useId: function () {
    ...
    function Pc(e, t, n, r, a) {
      if (
        ...
        if (
          ...
          switch (n.tag) {
            ...
            case 19:
              return (
                Io === null ? Kd() : n.alternate === null && Y === 0 && (Y = 3),
                (n.flags &= -257),
                (n.flags |= 65536),
                (n.lanes = a),
                r === no
      ...
      if (I)
        return (
          (t = Fo.current),
          t === null
            ? (r !== da && ((t = Error(i(423), { cause: r })), va(qi(t, n))),
            ...
            : (!(t.flags & 65536) && (t.flags |= 256),
              (t.flags |= 65536),
              (t.lanes = a),
              r !== da && ((e = Error(i(422), { cause: r })), va(qi(e, n)))),
          !1
        );
    ...
    function Rc(e, t, n, r, i) {
      ...
      return (
        ...
        e !== null && !Ic
          ? (ss(e, t, i), fl(e, t, i))
          : (I && s && aa(t), (t.flags |= 1), Lc(e, t, r, i), t.child)
      );
    }
    ...
    function Vc(e, t, n, r) {
      ...
      if (
        ...
        a === null
          ? (e !== null && Za(t, null), No(), Bo())
          : (Za(t, a.cachePool), Mo(t, a), Bo(), (t.memoizedState = null));
      ...
      if (o !== null) {
        ...
        if ((Ro(t), a)) {
          ...
          if (Ao.current === null) {
            if (
              ((r = G),
              r !== null && ((s = Et(r, n)), s !== 0 && s !== o.retryLane))
            )
              throw ((o.retryLane = s), Mi(e, s), Pd(r, e, s), Fc);
            Kd();
          }
          t = Gc(e, t, n);
        } else
    ...
    function Jc(e, t, n, r, i) {
      return (
        ...
        e !== null && !Ic
          ? (ss(e, t, i), fl(e, t, i))
          : (I && r && aa(t), (t.flags |= 1), Lc(e, t, n, i), t.child)
      );
    }
    function Yc(e, t, n, r, i, a) {
      return (
        ...
        e !== null && !Ic
          ? (ss(e, t, a), fl(e, t, a))
          : (I && r && aa(t), (t.flags |= 1), Lc(e, t, n, a), t.child)
      );
    }
    ...
    function al(e, t, n, r, a, o, s, c) {
      ...
      if ((Ic || Ea(e, t, c, !1), (r = (c & e.childLanes) !== 0), Ic || r)) {
        ...
        if (
          ((r = G),
          r !== null && ((a = Et(r, c)), a !== 0 && a !== s.retryLane))
        )
          throw ((s.retryLane = a), Mi(e, a), Pd(r, e, a), Fc);
    ...
    function pl(e, t) {
      return (
        (e.lanes & t) !== 0 || ((e = e.dependencies), !!(e !== null && Da(e)))
      );
    }
    function ml(e, t, n) {
      switch (t.tag) {
    ...
    function hl(e, t, n) {
      ...
      switch (((t.lanes = 0), t.tag)) {
        case 16:
          a: {
            var r = t.pendingProps;
            if (((e = ao(t.elementType)), (t.type = e), typeof e == `function`))
              Ri(e)
          ...
          return (
            ...
            e === null
              ? (n = Nm(t.type, null, t.pendingProps, null))
                ? (t.memoizedState = n)
                : I || (t.stateNode = fp(t.type, t.pendingProps, Ne.current, t))
              : (t.memoizedState = Nm(
                  t.type,
                  e.memoizedProps,
                  t.pendingProps,
        ...
        case 27:
          return (
            ...
            e === null &&
              ...
              (ua = !0),
              (a = F),
              Sp(t.type) ? ((um = a), (F = lm(r.firstChild))) : (F = a)),
        ...
        case 5:
          return (
            e === null &&
              I &&
              ((a = r = F) &&
                ((r = rm(r, t.type, t.pendingProps, ua)),
                r === null
                  ? (a = !1)
                  : ((t.stateNode = r),
                    (ca = t),
            ...
            t.memoizedState !== null &&
              ((a = ns(e, t, as, null, null, n)), (sh._currentValue = a)),
            qc(e, t),
            Lc(e, t, r, n),
            t.child
          );
        case 6:
          return (
            e === null &&
              I &&
              ((e = n = F) &&
                ((n = im(n, t.pendingProps, ua)),
                n === null
                  ? (e = !1)
                  : ((t.stateNode = n), (ca = t), (F = null), (e = !0))),
              e || fa(t)),
            null
          );
        case 13:
          ...
          return (
            ...
            e === null
              ? ((a = Xa()),
                ...
                yo(t),
                Sa(t, Fa, a))
              : ((e.lanes & n) !== 0 && (bo(e, t), Do(t, null, null, n), Eo()),
                (a = e.memoizedState),
                (o = t.memoizedState),
                a.parent === r
                  ? ((r = o.cache),
      ...
      switch ((oa(t), t.tag)) {
        ...
        case 27:
          if (
            ...
            ((e = je.current),
              ha(t) ? pa(t, e) : ((e = hm(a, r, n)), (t.stateNode = e), gl(t)));
          }
          return (V(t), (t.subtreeFlags &= -33554433), null);
        case 5:
        ...
        case 6:
          if (e && t.stateNode != null) e.memoizedProps !== r && gl(t);
            ...
            if (((e = Ne.current), ha(t))) {
              ...
              ((e = lp(e).createTextNode(r)), (e[Mt] = t), (t.stateNode = e));
          }
          return (V(t), null);
        case 31:
        ...
        case 19:
          ...
          if (r.tail !== null) {
            ...
            return (
              ...
              (o = Ho.current),
              (o = a ? (o & 1) | 2 : o & 1),
              r.tailMode === `visible` || r.tailMode === `collapsed` || !n || I
                ? Uo(t, o)
                : ((n = o), D(Fo, t), D(Ho, n), Io === null && (Io = t)),
              I && ra(t, r.treeForkCount),
              e
            );
          }
      ...
      for (; du !== null; ) {
        ...
        switch (t.tag) {
          ...
          case 30:
            n &&
              r !== null &&
              ((n = Si(r.memoizedProps, r.stateNode)),
              (a = t.memoizedProps),
            ...
            : (J =
                t === Fc
                  ...
                  : typeof t == `object` && t && typeof t.then == `function`
                    ...
                    : 1),
        (nd = t),
        K === null && ((Y = 1), kc(e, qi(t, e.current))));
    }
    function Ud() {
      var e = Fo.current;
      return e === null
    ...
    function Qd(e) {
      ...
      switch (t.tag) {
        ...
        case 5:
          ...
          r === ca &&
            (I
              ? (ma(r), r.tag === 5 && r.stateNode != null && (F = r.stateNode))
              : (ma(r), (I = !0)));
        default:
          (Cl(n, t), (t = K = Bi(t, od)), (t = hl(n, t, od)));
      }
      ((e.memoizedProps = e.pendingProps), t === null ? ef(e) : (K = t));
    }
    function $d(e, t, n, r) {
    ...
    function gf(e, t) {
      (t === 0 && (t = xt()), (e = Mi(e, t)), e !== null && (Ct(e, t), Ef(e)));
    }
    function _f(e) {
      var t = e.memoizedState,
        n = 0;
            ...
            for (var m = r, h; m !== null; ) {
              ...
              if (
                ...
                (g !== 5 && g !== 26 && g !== 27) ||
                  h === null ||
                  p === null ||
                  ((g = jn(m, p)), g != null && d.push(qf(m, g, h))),
                f)
              )
                break;
              m = m.return;
          ...
          (b &&
            (yr &&
              ...
              (wr || b !== `onCompositionStart`
                ? b === `onCompositionEnd` && wr && (y = Rn())
                : ((Fn = i),
                  (In = `value` in Fn ? Fn.value : Fn.textContent),
                  (wr = !0))),
            (v = Jf(r, b)),
            0 < v.length &&
              ((b = new nr(b, e, null, n, i)),
              s.push({ event: b, listeners: v }),
              y ? (b.data = y) : ((y = Cr(n)), y !== null && (b.data = y)))),
            (y = vr ? Tr(e, n) : Er(e, n)) &&
              ((b = Jf(r, `onBeforeInput`)),
              0 < b.length &&
                ((v = new nr(`onBeforeInput`, `beforeinput`, null, n, i)),
    ...
    function Xf(e, t, n, r, i) {
      for (var a = t._reactName, o = []; n !== null && n !== r; ) {
        ...
        ((s !== 5 && s !== 26 && s !== 27) ||
          ...
          ((c = l),
          i
            ? ((l = jn(n, a)), l != null && o.unshift(qf(n, l, c)))
            : i || ((l = jn(n, a)), l != null && o.push(qf(n, l, c)))),
          (n = n.return));
      }
      ...
      switch (t) {
        ...
        case `select`:
          ...
          ((t = o),
            (n = s),
            (e.multiple = !!r),
            t == null ? n != null && fn(e, !!r, n, !0) : fn(e, !!r, t, !1));
          return;
        case `textarea`:
    ...
    function km(e, t) {
      ...
      if (n && e) {
        var r = t && typeof t.as == `string` ? t.as : `script`,
          i =
            `link[rel="modulepreload"][as="` + P(r) + `"][href="` + P(e) + `"]`,
          a = i;
        switch (r) {
          case `audioworklet`:
          case `paintworklet`:
    ...
    function Lm(e, t, n, r) {
      if ((t = e.querySelector(`link[rel="preload"][as="style"][` + t + `]`))) {
        ...
        ((t = e.createElement(`link`)),
          (t[Lt] = !0),
          (t.onload = t.onerror = Ut.bind(null, t)),
          np(t, `link`, n),
          M(t),
          ...
          for (; i !== null; ) {
            ...
            if (a !== null)
              switch (a.tag) {
                ...
                case 31:
                case 13:
                  ((s = Mi(a, 2)), s !== null && Pd(s, a, 2), zd(), ph(a, 2));
              }
...
function ne(e, t = {}) {
  let n = t.attributeNames ?? {},
    r = (e) => n[e] ?? e,
    i = e.size ?? e.width ?? x.width,
    a = e.size ?? e.height ?? x.height,
    o =
      e.aliases
    ...
    l = t.includeDefaultClasses === !1 ? ee(...c) : ee(`lucide`, ...s, ...c),
    u = t.absoluteStrokeWidth
      ? (Number(t.strokeWidth ?? x[`stroke-width`]) *
          Number(e.size ?? e.width ?? x.width)) /
        Number(t.size ?? t.width ?? x.width)
      : (t.strokeWidth ?? x[`stroke-width`]);
  return [
    `svg`,
    {
      ...
      ...(`size` in t &&
        te(t.size) && { [r(`width`)]: t.size, [r(`height`)]: t.size }),
...
var re = (e) => {
  ...
  C = c(u(), 1),
  ie = (0, C.createContext)({}),
  ae = () => (0, C.useContext)(ie),
  oe = (0, C.forwardRef)(
    (
      {
        color: e,
      ...
      return (0, C.createElement)(b, { ref: f, ...x }, [
        ...te.map(([e, t]) => (0, C.createElement)(e, t)),
        ...(Array.isArray(c) ? c : [c]),
      ]);
    },
  );
function w(e, t = [], n = []) {
  let r = typeof e == `string` ? v(e, t, n) : e,
    i = (0, C.forwardRef)(({ className: e, ...t }, n) =>
      (0, C.createElement)(oe, { ref: n, icon: r, className: e, ...t }),
    );
...
var Ct = w(St),
  ...
  Et = `http://192.168.1.101:3000/api/v1`.replace(/\/$/, ``),
  Dt = `gstech_access_token`,
  Ot = `gstech_refresh_token`,
  kt = {
    superadmin: {
      label: `Super Admin`,
      accent: `Technique`,
  ...
  At = {
    superadmin: [
      [`dashboard`, `Tableau de bord`, Ve],
      [`users`, `Utilisateurs`, _t],
      [`establishments`, `Établissements`, ge],
      [`profile`, `Profil`, Ee],
    ...
    srio: [
      [`dashboard`, `Tableau de bord`, Ve],
      [`establishments`, `Établissements`, ge],
      [`managers`, `Gestionnaires`, pt],
      [`profile`, `Profil`, Ee],
    ],
    scq: [
      [`dashboard`, `Tableau de bord`, Ve],
      [`establishments`, `Établissements`, ge],
      [`directors`, `Directeurs`, ht],
      [`director-assign`, `Affectations`, ze],
      [`profile`, `Profil`, Ee],
    ],
    directeur: [
      [`dashboard`, `Tableau de bord`, Ve],
      [`formateurs`, `Formateurs`, pt],
      [`courses`, `Modules`, me],
      [`assign`, `Affectations`, ze],
      [`schedule`, `Emploi du temps`, ve],
      [`documents`, `Documents`, Ne],
      [`announcements`, `Annonces`, qe],
      [`profile`, `Profil`, Ee],
    ],
    gestionnaire: [
      [`dashboard`, `Tableau de bord`, Ve],
      [`groups`, `Groupes`, ze],
      [`students`, `Stagiaires`, Fe],
      [`documents`, `Documents`, Ne],
      [`justifications`, `Justificatifs`, Oe],
      [`profile`, `Profil`, Ee],
    ],
    formateur: [
      [`dashboard`, `Tableau de bord`, Ve],
      [`schedule`, `Emploi du temps`, ve],
      [`attendance`, `Présences`, Oe],
      [`grades`, `Notes`, be],
      [`announcements`, `Annonces`, qe],
      [`profile`, `Profil`, Ee],
    ],
    stagiaire: [
      [`dashboard`, `Accueil`, Le],
      [`schedule`, `Emploi du temps`, ve],
      [`attendance`, `Présences`, Oe],
      [`grades`, `Notes`, be],
      [`announcements`, `Annonces`, qe],
  ...
  k = (e) =>
    ...
    `—`,
  Nt = async (e) => {
    if (e.status === 401) return `Identifiants invalides ou session expirée.`;
    if (e.status === 403) return `Accès refusé pour ce compte.`;
    if (e.status === 429) return `Trop de tentatives. Réessayez plus tard.`;
    if (e.status >= 500)
      return `Le serveur a rencontré une erreur. Réessayez plus tard.`;
    try {
      let t = await e.json();
      return Array.isArray(t.message)
        ? t.message.join(` `)
        : t.message || t.error || `Erreur HTTP ${e.status}`;
    } catch {
      return `Erreur HTTP ${e.status}`;
    }
  },
  Pt = (e) => {
    try {
      ...
      return JSON.parse(
        atob(t.padEnd(t.length + ((4 - (t.length % 4)) % 4), `=`)),
      );
    } catch {
      return {};
    }
  ...
  A = new (class {
    constructor() {
      ((this.access = sessionStorage.getItem(Dt)),
        (this.refresh = sessionStorage.getItem(Ot)),
        (this.onUnauthorized = null));
    }
    setTokens(e, t) {
      ((this.access = e),
        (this.refresh = t),
        e ? sessionStorage.setItem(Dt, e) : sessionStorage.removeItem(Dt),
        t ? sessionStorage.setItem(Ot, t) : sessionStorage.removeItem(Ot));
    }
    clear() {
    ...
    async request(e, t = {}, n = !0) {
      ...
      (t.body instanceof FormData || r.set(`Content-Type`, `application/json`),
        this.access && r.set(`Authorization`, `Bearer ${this.access}`));
      let i;
      try {
        i = await fetch(`${Et}${e}`, { ...t, headers: r });
      } catch {
        throw Error(
          `Impossible de joindre l'API (${Et}). Vérifiez le réseau et CORS.`,
        );
      }
      if (i.status === 401 && n && this.refresh)
        try {
          let n = await fetch(`${Et}/auth/refresh`, {
            method: `POST`,
          ...
          (this.clear(), this.onUnauthorized?.());
        }
      if (!i.ok) throw Error(await Nt(i));
      return i.status === 204
        ? null
        : (i.headers.get(`content-type`) || ``).includes(`application/json`)
          ? i.json()
          : i.blob();
    }
    get(e) {
...
function j(e, t = []) {
  let [n, r] = (0, C.useState)({ data: null, loading: !0, error: `` }),
    i = () => {
      if (!e) {
        r({ data: null, loading: !1, error: `` });
        return;
      }
      (r((e) => ({ ...e, loading: !0, error: `` })),
        A.get(e)
          .then((e) => r({ data: e, loading: !1, error: `` }))
          .catch((e) => r({ data: null, loading: !1, error: e.message })));
    };
  return ((0, C.useEffect)(i, t), { ...n, reload: i });
}
function Ft() {
  let [e, t] = (0, C.useState)(() => (A.access ? Pt(A.access) : null)),
    [n, r] = (0, C.useState)(
      () => location.hash.replace(`#/`, ``) || `dashboard`,
    ),
    [i, a] = (0, C.useState)(() => localStorage.getItem(`gstech_dark`) === `1`),
    [o, s] = (0, C.useState)(!1),
    [c, l] = (0, C.useState)(``),
    [u, d] = (0, C.useState)(!1),
    [f, p] = (0, C.useState)(!1),
  ...
  ((0, C.useEffect)(() => {
    A.onUnauthorized = () => t(null);
  }, []),
    (0, C.useEffect)(() => {
      ((document.documentElement.dataset.theme = i ? `dark` : `light`),
        localStorage.setItem(`gstech_dark`, i ? `1` : `0`));
    }, [i]),
    (0, C.useEffect)(() => {
      let e = () => r(location.hash.replace(`#/`, ``) || `dashboard`);
      return (
        addEventListener(`hashchange`, e),
        () => removeEventListener(`hashchange`, e)
      );
    }, []));
  let g = (e) => {
      ((location.hash = `/${e}`), s(!1));
    ...
    _ = (e, t) => {
      (h({ type: e, message: t }), setTimeout(() => h(null), 3500));
    },
    v = async (e, n) => {
      let r = e.trim().toLowerCase();
      if (r.length > 255) throw Error(`Adresse e-mail trop longue.`);
      if (n.length < 8 || n.length > 128)
        throw Error(`Le mot de passe doit contenir entre 8 et 128 caractères.`);
      let i = await A.post(`/auth/login`, { email: r, password: n });
      if (i.requiresTwoFactor)
        return { requiresTwoFactor: !0, challengeToken: i.challengeToken };
      A.setTokens(i.accessToken, i.refreshToken);
      let a = Pt(i.accessToken);
      if (!a.sub || !kt[a.role])
        throw (A.clear(), Error(`Session reçue invalide.`));
      (t(a), g(`dashboard`));
    },
    y = async (e, n) => {
      if (!/^\d{6}$/.test(n))
        throw Error(`Le code doit contenir exactement 6 chiffres.`);
      let r = await A.post(`/auth/verify-2fa`, { challengeToken: e, code: n });
      A.setTokens(r.accessToken, r.refreshToken);
      let i = Pt(r.accessToken);
      if (!i.sub || !kt[i.role])
        throw (A.clear(), Error(`Session reçue invalide.`));
      (t(i), g(`dashboard`));
    },
    b = async () => {
      try {
        A.refresh &&
          (await A.post(`/auth/logout`, { refreshToken: A.refresh }));
      } catch {}
      (A.clear(), t(null));
    };
  if (!e || !e.sub || !kt[e.role])
    return (0, O.jsx)(Lt, { onLogin: v, onVerify: y, apiBase: Et });
  let ee = e.role,
    x = kt[ee] || kt.df;
  return (0, O.jsxs)(`div`, {
    className: `app`,
    children: [
      (0, O.jsxs)(`aside`, {
        className: `sidebar ${o ? `mobile-open` : ``}`,
        children: [
          (0, O.jsxs)(`div`, {
            className: `brand`,
            children: [
              ...
              (0, O.jsxs)(`div`, {
                children: [
                  (0, O.jsx)(`strong`, { children: `GSTechStudent` }),
                  (0, O.jsx)(`span`, { children: `Plateforme Web` }),
                ],
              }),
              (0, O.jsx)(`button`, {
                className: `icon-btn side-close`,
                onClick: () => s(!1),
                children: (0, O.jsx)(xt, { size: 18 }),
              }),
            ],
          }),
          (0, O.jsxs)(`div`, {
            className: `live-pill`,
            children: [
              (0, O.jsx)(`span`, { className: `pulse` }),
              ` API connectée`,
              ` `,
              (0, O.jsx)(`small`, { children: new URL(Et).host }),
            ],
          }),
          (0, O.jsxs)(`div`, {
            className: `role-box`,
            children: [
              ...
              (0, O.jsxs)(`button`, {
                ...
                children: [
                  (0, O.jsxs)(`div`, {
                    children: [
                      (0, O.jsx)(`strong`, { children: x.label }),
                      (0, O.jsx)(`span`, { children: x.accent }),
                    ],
                  }),
                  (0, O.jsx)(Se, { size: 16 }),
                ],
              ...
              u &&
                (0, O.jsxs)(`div`, {
                  ...
                  children: [
                    (0, O.jsx)(`div`, {
                      className: `role-note`,
                      children: `Le rôle vient du compte API`,
                    }),
                    (0, O.jsxs)(`div`, {
                      className: `role-current`,
                      children: [
                        (0, O.jsx)(`span`, { children: x.label }),
                        (0, O.jsx)(`small`, { children: x.accent }),
                      ],
                    }),
                  ],
                }),
          ...
          (0, O.jsx)(`nav`, {
            children: (At[ee] || At.df).map(([e, t, r]) =>
              (0, O.jsxs)(
                `button`,
                {
                  className: `nav-item ${n === e ? `active` : ``}`,
                  onClick: () => g(e),
                  children: [
                    (0, O.jsx)(r, { size: 18 }),
              ...
              (0, O.jsxs)(`button`, {
                ...
                children: [
                  i
                    ...
                    : (0, O.jsx)(Ye, { size: 18 }),
                  (0, O.jsx)(`span`, {
                    children: i ? `Mode clair` : `Mode sombre`,
                  }),
                ],
              }),
              (0, O.jsxs)(`button`, {
                ...
                children: [
                  (0, O.jsx)(Ue, { size: 18 }),
                  (0, O.jsx)(`span`, { children: `Déconnexion` }),
                ],
              }),
            ],
          }),
          ...
          (0, O.jsxs)(`header`, {
            ...
            children: [
              (0, O.jsx)(`button`, {
                ...
                onClick: () => s(!0),
                children: (0, O.jsx)(Ge, { size: 19 }),
              }),
              (0, O.jsxs)(`div`, {
                className: `breadcrumbs`,
                children: [
                  (0, O.jsx)(`span`, { children: `GSTechStudent` }),
                  (0, O.jsx)(`b`, { children: `/` }),
                  (0, O.jsx)(`strong`, { children: It(n) }),
                ],
              }),
              (0, O.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, O.jsx)(`div`, {
                    className: `avatar`,
                    children: (e.email || `?`).slice(0, 1).toUpperCase(),
                  }),
                ],
              }),
            ],
      ...
      m &&
        (0, O.jsxs)(`div`, {
          className: `toast ${m.type === `error` ? `error` : `success`}`,
          children: [
            m.type === `error`
              ? (0, O.jsx)(we, { size: 17 })
              : (0, O.jsx)(T, { size: 17 }),
            (0, O.jsx)(`span`, { children: m.message }),
          ],
        }),
      f &&
        (0, O.jsxs)(cn, {
...
function Lt({ onLogin: e, onVerify: t, apiBase: n }) {
  let [r, i] = (0, C.useState)(``),
    [a, o] = (0, C.useState)(``),
    [s, c] = (0, C.useState)(null),
    [l, u] = (0, C.useState)(``),
    [d, f] = (0, C.useState)(!1),
    [p, m] = (0, C.useState)(``);
  return (0, O.jsxs)(`div`, {
    ...
    children: [
      (0, O.jsx)(`div`, { className: `login-orb orb-a` }),
      (0, O.jsx)(`div`, { className: `login-orb orb-b` }),
      (0, O.jsxs)(`div`, {
        ...
        children: [
            ...
            children: [
              ...
              (0, O.jsxs)(`div`, {
                children: [
                  (0, O.jsx)(`strong`, { children: `GSTechStudent` }),
                  (0, O.jsx)(`span`, {
                    children: `Plateforme de gestion OFPPT`,
                  }),
                ],
              }),
            ],
          ...
          s
            ? (0, O.jsxs)(`form`, {
                onSubmit: async (e) => {
                  (e.preventDefault(), f(!0), m(``));
                  try {
                    await t(s, l);
                  } catch (e) {
                    m(e.message || `Vérification impossible.`);
                  } finally {
                    f(!1);
                  }
                },
                ...
                children: [
                  (0, O.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, O.jsx)(`h1`, { children: `Code de sécurité` }),
                      (0, O.jsx)(`p`, {
                        children: `Un code de vérification a été envoyé à votre adresse e-mail.`,
                      }),
                    ],
                  }),
                  (0, O.jsxs)(`label`, {
                    children: [
                      ...
                      (0, O.jsx)(`input`, {
                        ...
                        value: l,
                        onChange: (e) =>
                          u(e.target.value.replace(/\D/g, ``).slice(0, 6)),
                        minLength: 6,
                        maxLength: 6,
                        required: !0,
                        placeholder: `000000`,
                  ...
                  (0, O.jsx)(`button`, {
                    ...
                    children: d
                      ? (0, O.jsxs)(O.Fragment, {
                          children: [
                            (0, O.jsx)($e, { className: `spin`, size: 17 }),
                            `Vérification...`,
                          ],
                        })
                      : (0, O.jsxs)(O.Fragment, {
                          children: [`Valider `, (0, O.jsx)(T, { size: 17 })],
                        }),
                  }),
                ],
              })
            : (0, O.jsxs)(`form`, {
                onSubmit: async (t) => {
                  (t.preventDefault(), f(!0), m(``));
                  try {
                    let t = await e(r, a);
                    t?.requiresTwoFactor && c(t.challengeToken);
                  } catch (e) {
                    m(e.message || `Connexion impossible.`);
                  } finally {
                    f(!1);
                  }
                },
                ...
                children: [
                  (0, O.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, O.jsx)(`h1`, { children: `Bienvenue` }),
                      (0, O.jsx)(`p`, {
                        children: `Connectez-vous avec le compte réellement enregistré dans GSTechStudent.`,
                      }),
                    ],
                  }),
                  (0, O.jsxs)(`label`, {
                  ...
                  (0, O.jsxs)(`div`, {
                    ...
                    children: [
                      (0, O.jsx)(st, { size: 16 }),
                      (0, O.jsx)(`span`, {
                        children: `JWT · validation serveur · limitation des tentatives · aucun accès direct à MySQL.`,
                      }),
                    ],
                  }),
                ],
...
function Rt({
  ...
  let o = { role: e, search: n, session: r, notify: i, onNavigate: a };
  return t === `dashboard`
    ? (0, O.jsx)(zt, { ...o })
    : t === `users`
      ? (0, O.jsx)(Ht, { ...o })
...
function zt({ role: e, session: t, onNavigate: n }) {
  let r = [
      `superadmin`,
      `df`,
      `srio`,
    ...
    i = [`superadmin`, `df`, `srio`, `scq`].includes(e),
    a = [`df`, `directeur`, `gestionnaire`, `formateur`].includes(e),
    o = [`df`, `directeur`, `formateur`, `stagiaire`].includes(e),
    s = j(r ? `/users` : null),
    c = j(i ? `/etablissements` : null),
    l = j(a ? `/classes` : null),
    u = j(o ? `/courses` : null),
    d = Array.isArray(l.data)
      ? l.data.reduce(
          (e, t) => e + Number(t.effectif ?? t.nombreStagiaires ?? 0),
          0,
        )
      : null,
    f = {
      users: Array.isArray(s.data) ? s.data.length : null,
      students: d,
      etabs: Array.isArray(c.data) ? c.data.length : null,
      classes: Array.isArray(l.data) ? l.data.length : null,
      courses: Array.isArray(u.data) ? u.data.length : null,
    },
    p =
      e === `stagiaire`
        ? [
            [`Cours`, f.courses ?? `—`, `Cours accessibles`, me],
            [`Présence`, `—`, `Suivi personnel`, ce],
            [`Notes`, `—`, `Évaluations`, be],
            [`Documents`, `—`, `Espace personnel`, Ne],
          ]
        : e === `superadmin`
          ? [
              [`Utilisateurs`, f.users ?? `—`, `Comptes visibles`, _t],
              [`API`, `OK`, `NestJS /api/v1`, rt],
              [`Sécurité`, `JWT`, `Session protégée`, st],
              [`Base`, `MySQL`, `Côté serveur`, Ae],
            ]
          : e === `formateur`
            ? [
                [`Stagiaires`, f.students ?? `—`, `Stagiaires accessibles`, Fe],
                [`Classes`, f.classes ?? `—`, `Classes accessibles`, ze],
                [`Présences`, `—`, `Suivi pédagogique`, Oe],
                [`Notes`, `—`, `Évaluations`, be],
              ]
            : [
                [
  ...
  return (0, O.jsxs)(O.Fragment, {
    children: [
        ...
        children: [
          (0, O.jsxs)(`div`, {
            children: [
              ...
              (0, O.jsx)(`h1`, {
                children: `Bonjour, bienvenue sur GSTechStudent`,
              }),
              (0, O.jsx)(`p`, {
                children: `Les informations affichées ici proviennent de l'API partagée avec l'application mobile.`,
              }),
              (0, O.jsxs)(`div`, {
                className: `hero-meta`,
                children: [
          ...
          (0, O.jsx)(`div`, {
            ...
            children: (0, O.jsxs)(`button`, {
              className: `secondary`,
              onClick: () => n(`profile`),
              children: [(0, O.jsx)(ht, { size: 16 }), `Mon profil`],
            }),
          }),
        ],
      }),
      ...
      (0, O.jsxs)(`div`, {
        ...
        children: [
          (0, O.jsx)(Bt, { role: e }),
          (0, O.jsx)(Vt, { role: e, onNavigate: n }),
        ],
      }),
    ],
  });
    ...
    children: [
      (0, O.jsxs)(`div`, {
        ...
        children: [
          (0, O.jsxs)(`div`, {
            children: [
              (0, O.jsx)(`h2`, { children: `Architecture en direct` }),
              (0, O.jsx)(`p`, {
                children: `Le même backend sert Android et Web.`,
              }),
            ],
          }),
          (0, O.jsxs)(`span`, {
            ...
            children: [
              (0, O.jsx)(`span`, { className: `dot live` }),
              `Connecté`,
            ],
          }),
        ],
      ...
      (0, O.jsxs)(`div`, {
        ...
        children: [
          (0, O.jsxs)(`div`, {
            children: [
              (0, O.jsx)(rt, {}),
              (0, O.jsx)(`b`, { children: `Web` }),
              (0, O.jsx)(`small`, { children: `React / Vite` }),
            ],
          }),
          ...
          (0, O.jsxs)(`div`, {
            children: [
              (0, O.jsx)(Ct, {}),
              (0, O.jsx)(`b`, { children: `API` }),
              (0, O.jsx)(`small`, { children: `NestJS / JWT` }),
            ],
          }),
          (0, O.jsx)(`span`, { children: `→` }),
          (0, O.jsxs)(`div`, {
            children: [
              (0, O.jsx)(Ae, {}),
              (0, O.jsx)(`b`, { children: `MySQL` }),
              (0, O.jsx)(`small`, { children: `gestion_stagiaires` }),
            ],
          }),
        ],
      }),
      (0, O.jsxs)(`div`, {
        ...
        children: [
          (0, O.jsx)(st, { size: 16 }),
          (0, O.jsx)(`span`, {
            children: `MySQL et MinIO restent côté serveur : le navigateur ne reçoit aucun secret de stockage.`,
          }),
        ],
      }),
    ],
...
function Vt({ role: e, onNavigate: t }) {
  return (0, O.jsxs)(`div`, {
    className: `panel`,
    children: [
      (0, O.jsx)(`div`, {
        ...
        children: (0, O.jsxs)(`div`, {
          children: [
            (0, O.jsx)(`h2`, { children: `Accès rapides` }),
            (0, O.jsx)(`p`, { children: `Actions adaptées à votre rôle.` }),
          ],
        }),
      }),
      (0, O.jsx)(`div`, {
        className: `quick-grid`,
        children: (e === `formateur`
          ? [
              [`groups`, `Groupes`, ze],
              [`students`, `Stagiaires`, Fe],
              [`announcements`, `Annonces`, qe],
          ...
          : e === `stagiaire`
            ? [
                [`schedule`, `Voir mon planning`, ve],
                [`grades`, `Consulter mes notes`, be],
                [`documents`, `Mes documents`, Ne],
              ]
            : [
                [`users`, `Utilisateurs`, _t],
                [`establishments`, `Établissements`, ge],
                [`profile`, `Mon profil`, Ee],
              ]
        ).map(([e, n, r]) =>
          (0, O.jsxs)(
            `button`,
            {
              onClick: () => t(e),
              children: [
                (0, O.jsx)(`span`, { children: (0, O.jsx)(r, { size: 17 }) }),
                (0, O.jsxs)(`div`, {
                  children: [
                    (0, O.jsx)(`b`, { children: n }),
                    (0, O.jsx)(`small`, { children: `Ouvrir l'espace` }),
                  ],
                }),
                (0, O.jsx)(ue, { size: 15 }),
              ],
...
function Ht({ role: e, search: t, notify: n }) {
  let r = j(`/users`),
    [i, a] = (0, C.useState)(!1);
  return (0, O.jsxs)(O.Fragment, {
    children: [
      (0, O.jsx)(ln, {
        ...
        action: bn(e) ? `Créer un utilisateur` : null,
        onAction: () => a(!0),
      }),
      (0, O.jsx)(un, {
        loading: r.loading,
      ...
      i &&
        (0, O.jsx)(on, {
          ...
          onClose: () => a(!1),
          onDone: () => {
            (a(!1), r.reload(), n(`success`, `Utilisateur créé avec succès.`));
          },
        }),
    ],
  });
...
function M({
  ...
  let o = j(`/users?role=${encodeURIComponent(t)}`),
    s = bn(r) && Sn(r, n),
    [c, l] = (0, C.useState)(!1);
  return (0, O.jsxs)(O.Fragment, {
    children: [
      (0, O.jsx)(ln, {
        ...
        action: s ? `Créer un ${e.slice(0, -1).toLowerCase()}` : null,
        onAction: () => l(!0),
      }),
      (0, O.jsx)(un, {
        loading: o.loading,
      ...
      c &&
        (0, O.jsx)(on, {
          ...
          onClose: () => l(!1),
          onDone: () => {
            (l(!1), o.reload(), a(`success`, `Compte créé.`));
          },
        }),
    ],
  });
}
function Ut({ rows: e, role: t, notify: n, reload: r }) {
  return e?.length
    ? (0, O.jsx)(dn, {
        ...
        rows: e.map((e) => [
          ...
          e.region || `—`,
          e.email || `—`,
          (0, O.jsx)(`span`, { className: `badge success`, children: `Actif` }),
          e.idUtilisateur,
        ]),
        actions: (e) => xn(t, e?.role),
        data: e,
        notify: n,
        reload: r,
      })
    : (0, O.jsx)(hn, { text: `Aucun compte trouvé dans ce périmètre.` });
}
function Wt({ role: e, search: t, notify: n }) {
  let r = j(`/etablissements`),
    [i, a] = (0, C.useState)(!1),
    o = _n(r.data, t);
  return (0, O.jsxs)(O.Fragment, {
    children: [
      (0, O.jsx)(ln, {
        ...
        action: [`df`, `superadmin`].includes(e) ? `Ajouter un EFP` : null,
        onAction: () => a(!0),
      }),
      (0, O.jsx)(un, {
        loading: r.loading,
        ...
        children: o?.length
          ? (0, O.jsx)(dn, {
              ...
              rows: o.map((e) => [
                e.nomEtablissement,
                e.region || `—`,
                e.directeur ? k(e.directeur) : `—`,
                e.gestionnaires?.length ?? 0,
              ]),
              actions: !1,
            })
          : (0, O.jsx)(hn, { text: `Aucun établissement accessible.` }),
      }),
      i &&
        (0, O.jsx)(sn, {
          onClose: () => a(!1),
          onDone: () => {
            (a(!1), r.reload(), n(`success`, `Établissement créé.`));
          },
        }),
    ],
  });
...
function Gt({}) {
  let e = j(`/etablissements`),
    t = jt.map(([t, n]) => [
      t,
      n,
      (e.data || []).filter((e) => e.region === n).length,
    ]);
  return (0, O.jsxs)(O.Fragment, {
    children: [
      (0, O.jsx)(ln, {
...
function Kt({ role: e, search: t, notify: n }) {
  let r = j(`/classes`),
    i = _n(r.data, t);
  return (0, O.jsxs)(O.Fragment, {
    children: [
      (0, O.jsx)(ln, {
        ...
        action: [`df`, `gestionnaire`].includes(e) ? `Créer un groupe` : null,
      }),
      (0, O.jsx)(un, {
        loading: r.loading,
        error: r.error,
        ...
        children: i?.length
          ? (0, O.jsx)(dn, {
              ...
              rows: i.map((e) => [
                e.nomClasse || e.nom || `—`,
                e.filiere || e.specialite || `—`,
                e.effectif ?? e.nombreStagiaires ?? `—`,
                e.idEtablissement || `—`,
                e.idClasse || `—`,
              ]),
              actions: !1,
            })
          : (0, O.jsx)(hn, { text: `Aucun groupe accessible.` }),
      }),
    ],
  });
}
function qt({ role: e, search: t }) {
  let n = j(`/courses`),
    r = _n(n.data, t);
  return (0, O.jsxs)(O.Fragment, {
    children: [
      (0, O.jsx)(ln, {
        ...
        action: [`df`, `directeur`].includes(e) ? `Créer un module` : null,
      }),
      (0, O.jsx)(un, {
        loading: n.loading,
        error: n.error,
        ...
        children: r?.length
          ? (0, O.jsx)(dn, {
              ...
              rows: r.map((e) => [
                e.nomCours || e.nom || e.intitule || `—`,
                e.volumeHoraire ? `${e.volumeHoraire} h` : `—`,
                e.idCours || e.id || `—`,
                (0, O.jsx)(`span`, {
                  className: `badge success`,
                  children: `Actif`,
          ...
          : (0, O.jsx)(hn, { text: `Aucun module accessible.` }),
      }),
    ],
  });
}
function Jt({ role: e, search: t, notify: n }) {
  let r = j(`/etablissements`),
    i = j(`/users?role=directeur`),
    a = _n(r.data, t),
    o = async (e, t) => {
      try {
        (await A.post(`/etablissements/${e}/directeur`, { idUtilisateur: t }),
          n(`success`, `Directeur affecté à l’établissement.`),
          r.reload());
      } catch (e) {
        n(`error`, e.message);
      }
                ...
                children: [
                  (0, O.jsx)(`thead`, {
                    children: (0, O.jsxs)(`tr`, {
                      children: [
                        (0, O.jsx)(`th`, { children: `Établissement` }),
                        (0, O.jsx)(`th`, { children: `Région` }),
                        (0, O.jsx)(`th`, { children: `Directeur` }),
                      ],
                    }),
                  }),
                  (0, O.jsx)(`tbody`, {
                    children: a.map((e) =>
                      (0, O.jsxs)(
                        ...
                        {
                          children: [
                            (0, O.jsx)(`td`, { children: e.nomEtablissement }),
                            (0, O.jsx)(`td`, { children: e.region || `—` }),
                            (0, O.jsx)(`td`, {
                              children: (0, O.jsxs)(`select`, {
                                value: e.idDirecteur || ``,
                                onChange: (t) => {
                                  t.target.value &&
                                    o(e.idEtablissement, t.target.value);
                                },
                                children: [
                                  (0, O.jsx)(`option`, {
                                    value: ``,
...
function Yt({ role: e, search: t }) {
  let n = j(`/affectations`),
    r = _n(n.data, t);
  return (0, O.jsxs)(O.Fragment, {
    children: [
      (0, O.jsx)(ln, {
        ...
        action: [`df`, `directeur`].includes(e)
      ...
      (0, O.jsx)(un, {
        ...
        children: r?.length
          ? (0, O.jsx)(dn, {
              ...
              rows: r.map((e) => [
                e.classe?.nomClasse || e.nomClasse || e.idClasse || `—`,
                e.cours?.nomCours || e.cours?.nom || e.idCours || `—`,
                e.formateur ? k(e.formateur) : e.idFormateur || `—`,
                e.periode || e.dateDebut || `—`,
                e.idAffectation || e.id || `—`,
              ]),
              actions: !1,
            })
          : (0, O.jsx)(hn, { text: `Aucune affectation accessible.` }),
      }),
    ],
  });
}
function Xt({ role: e, search: t }) {
  let n = j(
      [`formateur`, `stagiaire`, `df`, `directeur`].includes(e)
        ? `/schedule`
        : null,
    ),
    r = [`Lun`, `Mar`, `Mer`, `Jeu`, `Ven`],
    i = _n(Array.isArray(n.data) ? n.data : [], t);
  return (0, O.jsxs)(O.Fragment, {
    children: [
      (0, O.jsx)(ln, {
        title: `Emploi du temps`,
        subtitle: `Créneaux issus de l'API`,
        action: [`df`, `directeur`].includes(e) ? `Créer un créneau` : null,
      }),
      n.error
        ? (0, O.jsx)(mn, { error: n.error, reload: n.reload })
        : !n.loading && i.length
          ? (0, O.jsx)(`div`, {
                ...
                (0, O.jsxs)(
                  `div`,
                  {
                    ...
                    children: [
                          ...
                          (0, O.jsxs)(
                            `div`,
                            {
                              ...
                              children: [
                                ...
                                (0, O.jsx)(`small`, {
                                  children: e.salle || `Salle non renseignée`,
                                }),
                              ],
                            },
                            t,
                      ...
                      i.filter((t) => vn(t) === e).length === 0 &&
                        (0, O.jsx)(`div`, {
                          className: `empty-slot`,
                          children: `Aucun créneau`,
                        }),
                    ],
                  },
                  e,
          ...
          : n.loading
            ? (0, O.jsx)(pn, {})
            : (0, O.jsx)(hn, {
                text: `Aucun créneau accessible pour ce compte.`,
              }),
    ],
  });
}
function Zt({ role: e, session: t }) {
  let n = j(
    e === `stagiaire` ? `/attendance/stagieres/${t.sub}/history` : null,
  );
  return e === `stagiaire`
    ? (0, O.jsxs)(O.Fragment, {
        children: [
          ...
          n.error
            ...
            : n.loading
              ? (0, O.jsx)(pn, {})
              : Array.isArray(n.data) && n.data.length
                ? (0, O.jsx)(un, {
                    children: (0, O.jsx)(dn, {
                      headers: [`Date`, `Cours`, `Statut`],
                      rows: n.data.map((e) => [
                        e.date || e.createdAt || `—`,
                        e.cours?.nomCours || e.cours?.nom || `—`,
                        e.statut || e.status || `—`,
                      ]),
                      actions: !1,
                    }),
...
function N({ role: e }) {
  ...
  return (0, O.jsxs)(O.Fragment, {
    children: [
      ...
      t.error
        ? (0, O.jsx)(mn, { error: t.error, reload: t.reload })
        : t.loading
          ? (0, O.jsx)(pn, {})
          : Array.isArray(t.data) && t.data.length
            ? (0, O.jsx)(un, {
                children: (0, O.jsx)(dn, {
                  headers:
                    e === `stagiaire`
                  ...
                  rows: t.data.map((t) =>
                    e === `stagiaire`
                      ? [
                          t.cours?.nomCours || t.cours?.nom || t.module || `—`,
                          t.evaluation || t.type || `—`,
                          t.note ?? `—`,
                          t.date || `—`,
                        ]
                      : [
                          t.classe?.nomClasse || t.idClasse || `—`,
                          t.cours?.nomCours || t.idCours || `—`,
                          t.periode || `—`,
                          t.idAffectation || t.id || `—`,
                        ],
                  ),
                  actions: !1,
                }),
            ...
            : (0, O.jsx)(hn, {
                text: `Aucune donnée de notation disponible pour ce compte.`,
              }),
    ],
  });
}
function Qt({ role: e, search: t, notify: n }) {
  let r = j(
      e === `gestionnaire`
        ? `/documents/mine`
        : e === `stagiaire`
          ? `/documents/approved`
          : [`df`, `directeur`].includes(e)
            ? `/documents/all`
            : null,
    ),
    i = j(
      [`gestionnaire`, `stagiaire`, `df`].includes(e)
        ? `/document-requests`
        : null,
    ),
    a = Array.isArray(r.data) ? r.data : [],
    o = Array.isArray(i.data) ? i.data : [],
    [s, c] = (0, C.useState)(!1);
  return (0, O.jsxs)(O.Fragment, {
    children: [
      (0, O.jsx)(ln, {
        ...
        action: e === `gestionnaire` ? `Créer un document` : null,
        onAction: () => c(!0),
      }),
      (0, O.jsxs)(`div`, {
        ...
        children: [
          (0, O.jsxs)(un, {
            ...
            reload: r.reload,
            children: [
              (0, O.jsx)(`h3`, { children: `Documents` }),
              a.length
                ? (0, O.jsx)(dn, {
                    headers: [`Nom`, `Statut`, `ID`],
                    rows: _n(a, t).map((e) => [
                      e.nomDocument || e.filename || e.nom || `—`,
                      e.statut || e.status || `—`,
                      e.idDocument || e.id || `—`,
                    ]),
                    actions: !1,
                  })
                : (0, O.jsx)(hn, { text: `Aucun document disponible.` }),
            ],
          }),
          (0, O.jsxs)(un, {
            loading: i.loading,
            ...
            reload: i.reload,
            children: [
              (0, O.jsx)(`h3`, { children: `Demandes` }),
              o.length
                ? (0, O.jsx)(dn, {
                    headers: [`Type`, `Demandeur`, `Statut`, `ID`],
                    rows: _n(o, t).map((e) => [
                      e.typeDocument || e.nomDocument || e.type || `—`,
                      e.stagiaire
                        ? k(e.stagiaire)
                        : e.requester || e.idStagiaire || `—`,
                      e.statut || e.status || `—`,
                      e.idDemande || e.id || `—`,
                    ]),
                    actions: !1,
                  })
                : (0, O.jsx)(hn, { text: `Aucune demande accessible.` }),
            ],
          }),
        ],
      }),
      s &&
        (0, O.jsx)($t, {
          ...
          onDone: () => {
            (c(!1),
              r.reload(),
              n(`success`, `Document envoyé au Directeur pour validation.`));
          },
        }),
    ],
  });
}
function $t({ onClose: e, onDone: t }) {
    ...
    children: (0, O.jsxs)(`form`, {
      ...
      onSubmit: async (e) => {
        if ((e.preventDefault(), i)) {
          ...
          try {
            let e = new FormData();
            (e.append(`file`, i, i.name),
              e.append(`nomDocument`, n.trim() || i.name),
              await A.request(`/documents/upload`, { method: `POST`, body: e }),
              t());
          } catch (e) {
            alert(e.message);
          } finally {
      ...
      children: [
        ...
        i &&
          (0, O.jsxs)(`small`, {
            children: [i.name, ` · `, (i.size / 1024 / 1024).toFixed(2), ` Mo`],
          }),
        (0, O.jsxs)(`div`, {
          className: `modal-actions`,
          children: [
            ...
            (0, O.jsx)(`button`, {
              className: `primary`,
              disabled: o || !i,
              children: o ? `Envoi...` : `Envoyer au Directeur`,
            }),
          ],
        }),
      ],
...
function en({ role: e }) {
  let t = j([`formateur`, `df`].includes(e) ? `/justifications` : null);
  return (0, O.jsxs)(O.Fragment, {
    children: [
      (0, O.jsx)(ln, {
        title: `Justificatifs`,
        subtitle: `Demandes liées aux absences`,
      }),
      t.error
        ? (0, O.jsx)(mn, { error: t.error, reload: t.reload })
        : t.loading
          ...
          : Array.isArray(t.data) && t.data.length
            ? (0, O.jsx)(un, {
                children: (0, O.jsx)(dn, {
                  ...
                  rows: t.data.map((e) => [
                    e.stagiaire ? k(e.stagiaire) : e.idStagiaire || `—`,
                    e.motif || e.reason || `—`,
                    e.date || e.createdAt || `—`,
                    e.statut || e.status || `—`,
                  ]),
            ...
            : (0, O.jsx)(hn, {
                text: `Aucun justificatif accessible pour ce rôle.`,
              }),
    ],
  });
}
function tn({ role: e, search: t, notify: n }) {
  let r = j(
      [`formateur`, `stagiaire`, `df`, `directeur`].includes(e)
        ? `/announcements`
        : null,
  ...
  return (0, O.jsxs)(O.Fragment, {
    children: [
      (0, O.jsx)(ln, {
        ...
        action: [`df`, `directeur`].includes(e) ? `Publier` : null,
        onAction: () => o(!0),
      }),
      (0, O.jsx)(un, {
        loading: r.loading,
        ...
        children: i?.length
                  ...
                  `div`,
                  {
                    ...
                    children: [
                      (0, O.jsx)(`div`, {
                        ...
                        children: (0, O.jsx)(fe, { size: 18 }),
                      }),
                      (0, O.jsxs)(`div`, {
                        children: [
                          (0, O.jsx)(`strong`, {
                            children: e.titre || e.title || `Annonce`,
                          }),
                          (0, O.jsx)(`p`, {
                            children:
                              e.contenu || e.message || e.description || `—`,
                          }),
                          (0, O.jsx)(`small`, {
                            children: e.datePublication || e.createdAt || `—`,
                          }),
                        ],
                      }),
                    ],
          ...
          : (0, O.jsx)(hn, { text: `Aucune annonce disponible.` }),
      }),
      a &&
        (0, O.jsx)(nn, {
          onClose: () => o(!1),
          onDone: () => {
            (o(!1), r.reload(), n(`success`, `Annonce publiée.`));
          },
          role: e,
        }),
    ],
...
function nn({ onClose: e, onDone: t, role: n }) {
  let [r, i] = (0, C.useState)(``),
    [a, o] = (0, C.useState)(``),
    [s, c] = (0, C.useState)(!1);
  return (0, O.jsx)(cn, {
    ...
    children: (0, O.jsxs)(`form`, {
      className: `modal-form`,
      onSubmit: async (e) => {
        if ((e.preventDefault(), r.trim() && a.trim())) {
          c(!0);
          try {
            (await A.post(`/announcements`, {
              titre: r.trim(),
              contenu: a.trim(),
        ...
        (0, O.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, O.jsx)(`button`, {
              className: `primary`,
              disabled: s,
              children: s ? `Publication...` : `Publier`,
            }),
          ],
        }),
      ],
...
function rn({ session: e }) {
  ...
  return (
    (0, C.useEffect)(() => {
      ...
      return (
        n?.profileImageKey &&
          A.get(`/users/${e.sub}/profile-image`)
            .then((e) => {
              ((t = URL.createObjectURL(e)), i(t));
            })
            .catch(() => {}),
        () => {
      ...
      children: [
        ...
        (0, O.jsx)(un, {
          ...
          children: n
                ...
                children: [
                  (0, O.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, O.jsxs)(`div`, {
                        children: [
                          (0, O.jsx)(`h2`, { children: k(n) }),
                          (0, O.jsx)(`p`, { children: n.email }),
                          (0, O.jsx)(`span`, {
                            className: `badge success`,
                  ...
                  (0, O.jsxs)(`div`, {
                    ...
                    children: [
                      (0, O.jsxs)(`div`, {
                        ...
                        children: [
                          (0, O.jsx)(`h2`, { children: `Informations` }),
                          (0, O.jsxs)(`div`, {
                            className: `info-grid`,
                            children: [
                              (0, O.jsxs)(`label`, {
                          ...
                          (0, O.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, O.jsxs)(`div`, {
                                children: [
                                  (0, O.jsx)(`strong`, {
                                    children: `Session JWT`,
                                  }),
                                  (0, O.jsx)(`small`, {
                                    children: `Access token 15 min · refresh token 7 jours`,
                                  }),
                                ],
                              }),
                              (0, O.jsx)(T, { size: 18 }),
            ...
            : (0, O.jsx)(hn, { text: `Profil introuvable.` }),
        }),
      ],
    })
  );
        ...
        children: [
          (0, O.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, O.jsxs)(`div`, {
                children: [
                  (0, O.jsx)(`span`, { children: `API` }),
                  (0, O.jsx)(`strong`, {
                    className: `small-value`,
                    children: `Connectée`,
                  }),
                  (0, O.jsx)(`small`, { children: `NestJS /api/v1` }),
                ],
              }),
            ],
          }),
          (0, O.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, O.jsxs)(`div`, {
                children: [
                  (0, O.jsx)(`span`, { children: `Base` }),
                  (0, O.jsx)(`strong`, {
                    className: `small-value`,
                    children: `Côté serveur`,
                  }),
                  (0, O.jsx)(`small`, {
                    children: `MySQL · gestion_stagiaires`,
                  }),
                ],
              }),
            ],
          ...
          (0, O.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, O.jsxs)(`div`, {
                children: [
                  (0, O.jsx)(`span`, { children: `Stockage` }),
                  (0, O.jsx)(`strong`, {
                    className: `small-value`,
                    children: `MinIO / S3`,
                  }),
                  (0, O.jsx)(`small`, { children: `Géré par l'API` }),
                ],
              }),
            ],
          }),
          (0, O.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, O.jsxs)(`div`, {
                children: [
                  (0, O.jsx)(`span`, { children: `Sécurité` }),
                  (0, O.jsx)(`strong`, {
                    className: `small-value`,
                    children: `JWT`,
                  }),
                  (0, O.jsx)(`small`, { children: `Access + refresh` }),
                ],
              }),
            ],
          }),
...
function on({ creatorRole: e, initialRole: t, onClose: n, onDone: r }) {
      ...
      onSubmit: async (e) => {
        ...
        try {
          ...
          if (
            ...
            e.password.length < 8 || e.password.length > 128)
          )
            throw Error(
        ...
        (0, O.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, O.jsx)(P, {
              ...
              onChange: (e) => l(`confirmPassword`, e),
              required: !0,
              minLength: 8,
              maxLength: 128,
              autoComplete: `new-password`,
            ...
            (0, O.jsxs)(`label`, {
              children: [
                ...
                (0, O.jsx)(`select`, {
                  value: i.role,
                  onChange: (e) => l(`role`, e.target.value),
                  children: c.map((e) =>
                    (0, O.jsx)(`option`, { value: e, children: Mt(e) }, e),
                  ),
                }),
              ],
            }),
            [`srio`, `scq`].includes(i.role) &&
              (0, O.jsxs)(`label`, {
                children: [
                  `Région`,
                  (0, O.jsxs)(`select`, {
                    value: i.region,
                    onChange: (e) => l(`region`, e.target.value),
                    required: !0,
                    children: [
                      (0, O.jsx)(`option`, {
                        value: ``,
            ...
            [`formateur`, `stagiaire`].includes(i.role) &&
              (0, O.jsx)(P, {
                label: i.role === `formateur` ? `Module` : `N° stagiaire`,
                value: i.role === `formateur` ? i.module : i.numerostagiaire,
                onChange: (e) =>
                  l(i.role === `formateur` ? `module` : `numerostagiaire`, e),
                required: !0,
              }),
            i.role === `stagiaire` &&
              (0, O.jsx)(P, {
            ...
            i.role === `superadmin` &&
              (0, O.jsx)(P, {
                ...
                value: i.niveauAcces,
                onChange: (e) => l(`niveauAcces`, e),
                required: !0,
              }),
            (0, O.jsx)(P, {
              label: `Téléphone`,
              value: i.telephone,
              onChange: (e) => l(`telephone`, e),
            }),
            (0, O.jsx)(P, {
              label: `CIN`,
              value: i.cin,
          ...
          children: [
            ...
            (0, O.jsx)(`button`, {
              ...
              children: o
                ? (0, O.jsxs)(O.Fragment, {
                    children: [
                      (0, O.jsx)($e, { className: `spin`, size: 15 }),
                      `Création...`,
                    ],
                  })
                : (0, O.jsxs)(O.Fragment, {
                    children: [`Créer `, (0, O.jsx)(Ze, { size: 15 })],
                  }),
            }),
          ],
        }),
...
function sn({ onClose: e, onDone: t }) {
  let [n, r] = (0, C.useState)(``),
    [i, a] = (0, C.useState)(``),
    [o, s] = (0, C.useState)(!1);
  return (0, O.jsx)(cn, {
    ...
    children: (0, O.jsxs)(`form`, {
      ...
      onSubmit: async (e) => {
        (e.preventDefault(), s(!0));
        try {
          (await A.post(`/etablissements`, { nomEtablissement: n, region: i }),
            t());
        } catch (e) {
          alert(e.message);
        } finally {
        ...
        (0, O.jsxs)(`label`, {
          children: [
            ...
            (0, O.jsxs)(`select`, {
              ...
              required: !0,
              children: [
                (0, O.jsx)(`option`, { value: ``, children: `Sélectionner` }),
                jt.map(([e, t]) =>
                  (0, O.jsx)(`option`, { value: e, children: t }, e),
                ),
              ],
...
function cn({ title: e, onClose: t, children: n }) {
  return (0, O.jsx)(`div`, {
      ...
      children: [
        (0, O.jsxs)(`div`, {
          ...
          children: [
            (0, O.jsxs)(`div`, {
              children: [
                (0, O.jsx)(`div`, { className: `eyebrow`, children: `ACTION` }),
...
function ln({ title: e, subtitle: t, action: n, onAction: r }) {
  return (0, O.jsxs)(`div`, {
    ...
    children: [
      ...
      n &&
        (0, O.jsxs)(`button`, {
          className: `primary`,
          onClick: r,
          children: [(0, O.jsx)(Ze, { size: 16 }), n],
        }),
    ],
  });
}
function un({ loading: e, error: t, reload: n, children: r }) {
  return e
    ? (0, O.jsx)(pn, {})
    : t
      ? (0, O.jsx)(mn, { error: t, reload: n })
      : (0, O.jsx)(`div`, { className: `panel data-panel`, children: r });
}
function dn({
  headers: e,
  rows: t,
    ...
    children: (0, O.jsxs)(`table`, {
      children: [
        (0, O.jsx)(`thead`, {
          children: (0, O.jsxs)(`tr`, {
            children: [
              e.map((e) => (0, O.jsx)(`th`, { children: e }, e)),
              n && (0, O.jsx)(`th`, {}),
            ],
          }),
        }),
        (0, O.jsx)(`tbody`, {
          children: t.map((e, t) => {
            let o = typeof n == `function` ? n(r[t]) : n;
            return (0, O.jsxs)(
              `tr`,
              {
                children: [
                  e.map((e, t) => (0, O.jsx)(`td`, { children: e }, t)),
                  n &&
                    (0, O.jsx)(`td`, {
                      children:
                        o &&
                        (0, O.jsx)(fn, { target: r[t], notify: i, reload: a }),
                    }),
                ],
              },
              t,
...
function fn({ target: e, notify: t, reload: n }) {
        ...
        children: [
          ...
          r &&
            (0, O.jsx)(`div`, {
              ...
              children: (0, O.jsxs)(`button`, {
                onClick: async () => {
                  if (confirm(`Supprimer ${k(e)} ?`))
                    try {
                      (await A.del(`/users/${e.idUtilisateur}`),
                ...
                children: [(0, O.jsx)(dt, { size: 14 }), `Supprimer`],
              }),
            }),
        ],
      })
...
function pn() {
  return (0, O.jsxs)(`div`, {
    ...
    children: [
      (0, O.jsx)(`div`, { className: `loader` }),
      (0, O.jsx)(`p`, { children: `Chargement des données...` }),
    ],
  });
}
function mn({ error: e, reload: t }) {
  return (0, O.jsxs)(`div`, {
    ...
    children: [
      ...
      (0, O.jsxs)(`div`, {
        children: [
          (0, O.jsx)(`strong`, {
            children: `Impossible de charger cette section`,
          }),
          (0, O.jsx)(`p`, { children: e }),
          (0, O.jsxs)(`button`, {
            className: `secondary`,
            onClick: t,
            children: [(0, O.jsx)($e, { size: 15 }), `Réessayer`],
          }),
        ],
      }),
    ],
...
function hn({ text: e }) {
  return (0, O.jsxs)(`div`, {
    ...
    children: [
      (0, O.jsx)(`div`, { children: (0, O.jsx)(ze, { size: 20 }) }),
      (0, O.jsx)(`strong`, { children: e }),
      (0, O.jsx)(`span`, {
        children: `Les données apparaîtront ici dès qu'elles sont disponibles.`,
      }),
    ],
  });
}
function gn({ icon: e, title: t, text: n }) {
  return (0, O.jsxs)(`div`, {
    className: `panel info-panel`,
    children: [
      (0, O.jsx)(`div`, {
        className: `info-icon`,
        children: (0, O.jsx)(e, { size: 20 }),
      }),
      (0, O.jsxs)(`div`, {
        children: [
...
function _n(e, t) {
  ...
  if (!t) return e;
  let n = t.toLowerCase();
  return e.filter((e) => JSON.stringify(e).toLowerCase().includes(n));
}
function vn(e) {
  let t = e.jour || e.day || ``;
  return (
    {
      ...
      4: `Jeu`,
      5: `Ven`,
    }[String(t).toLowerCase()] || String(t).slice(0, 3)
  );
}
function yn(e) {
  return e.heureDebut || e.startTime || e.heure || `—`;
}
function bn(e) {
  return [
    `superadmin`,
...
function wn(e) {
  return Cn(e)[0] || `stagiaire`;
}
(0, wt.createRoot)(document.getElementById(`root`)).render((0, O.jsx)(Ft, {}));
