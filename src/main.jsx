...
function App(){
  ...
  return <div className="app">
    <aside className={`sidebar ${mobile?'mobile-open':''}`}>
      <div className="brand"><img className="brand-logo" src="/logo.png" alt="GSTechStudent" /><div><strong>GSTechStudent</strong><span>Plateforme Web</span></div><button className="icon-btn side-close" onClick={()=>setMobile(false)}><X size={18}/></button></div>
...
function Login({onLogin,onVerify,apiBase}){
  ...
  return <div className="login-page"><div className="login-orb orb-a"/><div className="login-orb orb-b"/><div className="login-card">
    <div className="login-brand"><img className="brand-logo big" src="/logo.png" alt="GSTechStudent" /><div><strong>GSTechStudent</strong><span>Plateforme de gestion OFPPT</span></div></div>
