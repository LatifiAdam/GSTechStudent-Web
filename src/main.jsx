    ...
    <div className="app">
      <aside className={`sidebar ${mobile ? "mobile-open" : ""}`}>
        ...
        <div className="live-pill">
          <span className="pulse" /> API connectée{" "}
          <small>{new URL(API_BASE).host}</small>
        </div>
        ...
        <nav>
          {(NAV[role] || NAV.df).map(([id, label, Comp]) => (
            <button
              key={id}
    ...
    <>
      ...
      <div className="stats">
        <div className="stat-card">
          ...
          <div>
            <span>API</span>
            <strong className="small-value">Connectée</strong>
            <small>NestJS /api/v1</small>
          </div>
        </div>
        <div className="stat-card">
          <div className="stat-icon">
          ...
          <div>
            <span>Base</span>
            <strong className="small-value">Côté serveur</strong>
            <small>MySQL · gestion_stagiaires</small>
          </div>
        </div>
        <div className="stat-card">
          <div className="stat-icon">
          ...
          <div>
            <span>Stockage</span>
            <strong className="small-value">MinIO / S3</strong>
            <small>Géré par l'API</small>
          </div>
        </div>
        <div className="stat-card">
          <div className="stat-icon">
          ...
          <div>
            <span>Sécurité</span>
            <strong className="small-value">JWT</strong>
            <small>Access + refresh</small>
          </div>
        </div>
      </div>
      <InfoPanel
